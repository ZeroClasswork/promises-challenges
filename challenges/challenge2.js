 ...
 *    If greet() fails output should be
 *      Received an error!
 *      Name must be a string!
 *    This happens because the catch is what executes. uppercaser() doesn't
 *      still run.
 *
 ...
 *    run the code again.
 *    If greet() succeeds and uppercaser() fails, output should be
 *      Hello there, Ducky
 *      Received an error!
